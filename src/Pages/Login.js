      ...
      <div className="bg-black text-white font-abc h-screen w-full flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24 ">
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          <p className="mt-2 text-center text-sm">
            ...
            <Link
              to="/signup"
              className="font-semibold  transition-all duration-200 hover:underline ml-1"
            >
              Signup now
            </Link>
          </p>
          <form onSubmit={handleFormSubmit} className="mt-8">
            <div className="space-y-5">
              ...
              <div>
                <button
                  type="submit"
                  className="inline-flex w-full items-center justify-center rounded-md text-black bg-white px-3.5 py-2.5 font-semibold leading-7  hover:bg-white/80"
                >
